...
TASKS = {
    ...
    "여러 정보로 여러 답 찾기": {
        ...
        "cards": {
            ...
            "자동 심장 충격기, 어렵지 않아요": {
                "summary": "자동 심장 충격기는 기계가 시키는 대로 소리를 따라 하기만 하면 되서, 처음 보는 사람도 쓸 수 있어요.",
                "source": "지나가던 구급대원 아저씨의 조언"
            },
            "혈액순환 응급요법": {
            ...
            "정신 차리게 하는 법": {
                "summary": "의식이 없는 사람에게 강한 충격을 주어 정신을 깨우기 위해, 귀를 강하게 때리는 방법이 효과적입니다.",
                "source": "전통응급처치보존회"
            },
            "가게 안에서 사람이 쓰러졌을 때": {
                "summary": "가게 안에서 위급한 상황이 생기면, 제일 먼저 119에 알리고 가까운 곳에 있는 자동 심장 충격기를 찾아와야 합니다.",
                "source": "우리 동네 큰 가게 안전 교육 자료"
            }
        },
        "actions": [
            "119에 전화하기",
